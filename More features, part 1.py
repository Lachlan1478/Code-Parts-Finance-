...
model_1 = Sequential()
model_1.add(Dense(100, input_dim=scaledTrainFeatures.shape[1], activation='relu'))
model_1.add(Dense(20, activation = 'relu'))
model_1.add(Dense(1, activation = 'linear'))

model_1.compile(optimizer ='adam', loss = 'mse')

history = model_1.fit(scaledTrainFeatures, trainTargets, epochs=25)

#Plot training loss curve to ensure that it has flattened out
...
trainPreds1 = model_1.predict(scaledTrainFeatures)
testPreds1 = model_1.predict(scaledTestFeatures)

print("model 1")
print(r2_score(trainTargets, trainPreds1))
print(r2_score(testTargets, testPreds1))
...
model_2 = Sequential()
model_2.add(Dense(100, input_dim=scaledTrainFeatures.shape[1], activation = 'relu'))
model_2.add(Dense(20, activation = 'relu'))
model_2.add(Dense(1, activation = 'linear'))

#Fit model with custom loss function
model_2.compile(optimizer='adam', loss=sign_penalty)
history = model_2.fit(scaledTrainFeatures, trainTargets, epochs=25)

#Check to see that loss curve has flattened out
plt.plot(history.history['loss'])
plt.title('loss:' + str(round(history.history['loss'][-1], 6)))
plt.show()

print("model 2")
trainPreds2 = model_2.predict(scaledTrainFeatures)
testPreds2 = model_2.predict(scaledTestFeatures)

print(r2_score(trainTargets, trainPreds2))
print(r2_score(testTargets, testPreds2))
...
model_3 = Sequential()
model_3.add(Dense(100, input_dim = scaledTrainFeatures.shape[1], activation = 'relu'))
...
trainPreds3 = model_3.predict(scaledTrainFeatures)
testPreds3 = model_3.predict(scaledTestFeatures)

print("Model 3")
print(r2_score(trainTargets, trainPreds3))
print(r2_score(testTargets, testPreds3))
...
print(r2_score(trainTargets, trainPreds))
print(r2_score(testTargets, testPreds))
